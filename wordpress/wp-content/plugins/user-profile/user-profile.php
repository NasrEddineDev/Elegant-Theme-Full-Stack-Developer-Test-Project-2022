...
class UserProfile{
	...
	public function front_scripts(){
		...
		wp_enqueue_script('user_profile_front_js', plugins_url( '/assets/front/js/scripts.js' , __FILE__ ) , array( 'jquery' ), time("H:s") );
		...
		wp_enqueue_style('user_profile_style', USER_PROFILE_PLUGIN_URL.'assets/front/css/style.css', array(), time( "H:s") );	
	}
